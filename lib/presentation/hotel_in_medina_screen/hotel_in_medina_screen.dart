...
class HotelInMedinaScreen extends GetWidget<HotelInMedinaController> {
  const HotelInMedinaScreen({Key? key})
      : super(
          key: key,
        );
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    CustomImageView(
                                      imagePath: ImageConstant.imgStar26,
                                      height: 18.adaptSize,
                                      width: 18.adaptSize,
                                      radius: BorderRadius.circular(
                                        1.h,
      ...
      child: Obx(
        () => Row(
          children: [
            CustomRadioButton(
              text: "lbl_shared".tr,
              value: controller.hotelInMedinaModelObj.value.radioList.value[0],
            ...
            Padding(
              ...
              child: CustomRadioButton(
                ...
                text: "lbl_private".tr,
                value:
                    controller.hotelInMedinaModelObj.value.radioList.value[1],
                groupValue: controller.alFarisHotel.value,
                isRightCheck: true,
                onChange: (value) {
                  controller.alFarisHotel.value = value;
  ...
  Widget _buildFrame() {
    return Row(
      children: [
        ...
        CustomImageView(
          imagePath: ImageConstant.imgStar33,
          height: 18.adaptSize,
          width: 18.adaptSize,
          radius: BorderRadius.circular(
            1.h,
