...
class LogoOneScreen extends GetWidget<LogoOneController> {
  const LogoOneScreen({Key? key})
      : super(
          key: key,
        );
      ...
      child: Scaffold(
        body: SizedBox(
          ...
          child: Column(
            children: [
              CustomImageView(
                imagePath: ImageConstant.imgEllipse616136x132,
                height: 136.v,
                width: 132.h,
              ...
              CustomImageView(
                imagePath: ImageConstant.imgTripPana,
                height: 265.v,
                width: 352.h,
              ),
              SizedBox(height: 2.v),
